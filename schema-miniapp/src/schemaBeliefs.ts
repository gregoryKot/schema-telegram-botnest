...
export const SCHEMA_BELIEFS: Record<string, string[]> = {
  emotional_deprivation: [
    ...
    'Мне суждено остаться со своими переживаниями в одиночестве',
  ],
  abandonment: [
  ...
  dependence: ['Мне не справиться в одиночку', 'Без поддержки ничего не могу'],
  vulnerability: [
    'Что-то плохое вот-вот случится',
    'Мир опасен, и защиты у меня нет',
  ],
  enmeshment: [
  ...
  unrelenting_standards: [
    'От меня требуется безупречность',
