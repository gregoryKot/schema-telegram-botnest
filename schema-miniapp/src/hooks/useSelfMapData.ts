 ...
 * карта строится из неё.
 *
 * Пока грузится — экран показывает скелетон по форме будущего контента, а не
 * пустую карту: пустая карта читается как упрёк за безделье, и показывать её
 * человеку, у которого разборы есть, нельзя.
 */
