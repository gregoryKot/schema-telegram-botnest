...
} from './components/WeeklyQuestion';
...
const HAS_HISTORY = Object.keys(localStorage).some(
...
export default function App() {
  ...
  const [schemaInitialTab, setSchemaInitialTab] = useState<
    'needs' | 'schemas' | 'modes'
  >('needs');
                  ...
                  : showPlans
                    ...
                    : showAbout
                      ...
                      : showPairSheet
                        ...
                        : showChildhoodWheel
                          ? () => setShowChildhoodWheel(false)
                          : showPracticesOnboarding
  ...
  if (error) {
    ...
    return (
      ...
      >
        ...
        <div
          style={{ fontSize: 14, color: 'var(--text-sub)', lineHeight: 1.6 }}
        >
          {isAuthError
        ...
        <>
          ...
          {!showSettings && (
            ...
            >
              ...
              <div
                style={{ display: 'flex', alignItems: 'stretch', height: 60 }}
              >
                <div
                  style={{
                    flex: 1,
      ...
      {!therapistMode && section === 'today' && (
        <ErrorBoundary section="Сегодня" key="today-boundary">
          <TodaySection
            ...
            onOpenSchema={(opts) => {
              setSchemaAutoStartTest(!!opts?.startTest);
              setSchemaInitialTab(opts?.tab ?? 'needs');
              setSchemaHighlight(opts?.highlight);
