...
describe('HelpSection — единственный вход «Настроить экран» (Ж2, аудит 2026-08: пилюля у «Инструментов» терялась глубоко по скроллу — убрана)', () => {
  it('шестерёнка в шапке открывает лист настройки инструментов', async () => {
    await renderReady();
