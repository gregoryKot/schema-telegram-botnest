...
describe('DisclaimerWelcomeStep', () => {
  it('форма «ты»: приветствие и путь входа на месте', () => {
    ...
    // Фидбек владельца 2026-08-31: «часть» — жаргон, термин вводится только
    // внутри разбора; в приветствии его быть не должно.
    expect(
      screen.getByText(/что это было и чего в тот момент не хватило/),
    ).toBeTruthy();
    expect(document.body.textContent).not.toMatch(/част[ьи]/i);
    expect(
