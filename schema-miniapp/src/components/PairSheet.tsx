        ...
        {!data ? (
          ...
          <>
            ...
            {data.partners.map((partner) => {
              ...
              const done =
                partner.partnerTodayDone && partner.partnerIndex !== null;
              const color = done
                ...
                >
                      ...
                      {[...partner.partnerWeekAvgs].reverse().map((v, i) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            />
                            {v !== null &&
                              i === partner.partnerWeekAvgs.length - 1 && (
                                <div
                                  style={{
                                    fontSize: 9,
                                    color: 'var(--text-sub)',
                  ...
                  {confirmLeaveCode === partner.code ? (
                    <div style={{ display: 'flex', gap: 8 }}>
                      ...
                      <button
                        onClick={() => handleLeave(partner.code)}
                        style={{
                          flex: 1,
                          padding: '9px',
                          border: 'none',
            ...
            {view === 'main' ? (
              <>
                {data.partners.length === 0 && !data.pendingCode && (
                  ...
                  >
                    Приглашай друга или партнёра — видите индексы дня друг
                    друга. Не детали, только число. Просто знать, как день у
                    другого.
                  </p>
                )}
