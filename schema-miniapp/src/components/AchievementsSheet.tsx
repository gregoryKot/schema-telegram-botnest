...
> = {
  ...
  pair_connected: {
    emoji: '🫂',
    title: 'Не одни',
    desc: 'Отслеживаете потребности вместе с другом',
  },
};
              ...
              >
                <div
                  style={{
                    fontSize: 28,
                    marginBottom: 8,
                    filter: a.earned ? 'none' : 'grayscale(1) opacity(0.3)',
                  }}
                >
                  {m.emoji}
                </div>
      ...
      {selected && meta && (
        ...
        >
          <div
            ...
            style={{
              background:
                'linear-gradient(145deg, color-mix(in srgb, var(--accent) 20%, transparent), rgba(79,163,247,0.1))',
              border:
