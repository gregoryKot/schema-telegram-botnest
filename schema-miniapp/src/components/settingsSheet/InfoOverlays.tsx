  ...
  return (
    <BottomSheet onClose={onClose} zIndex={300}>
      <div style={{ paddingTop: 8 }}>
        <div style={HEADING_STYLE}>Зачем уведомления</div>
        <p
          style={{
            fontSize: 15,
...
export function PairInfoOverlay({ onClose }: { onClose: () => void }) {
  return (
    <BottomSheet onClose={onClose} zIndex={300}>
      <div style={{ paddingTop: 8 }}>
        <div style={HEADING_STYLE}>Зачем привязывать друга</div>
        <p
          style={{
            fontSize: 15,
            color: 'var(--text)',
...
export function TherapistInfoOverlay({ onClose }: { onClose: () => void }) {
  return (
    <BottomSheet onClose={onClose} zIndex={300}>
      <div style={{ paddingTop: 8 }}>
        <div style={HEADING_STYLE}>Зачем подключать терапевта</div>
        <p
          style={{
            fontSize: 15,
            color: 'var(--text)',
