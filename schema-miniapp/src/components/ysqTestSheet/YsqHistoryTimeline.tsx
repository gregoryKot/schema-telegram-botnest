import { countActiveInHistory } from '../../hooks/useYsqTest';
import type { YsqHistoryEntry } from './types';

interface Props {
  history: YsqHistoryEntry[];
}

// Таймлайн истории прохождений теста. Родитель рендерит только при
// history.length >= 2.
