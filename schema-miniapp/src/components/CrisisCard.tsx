...
export function CrisisCard() {
  ...
  return (
    <div role="status" style={{
      ...
      borderRadius: 14, padding: '14px 16px', margin: '12px 0', lineHeight: 1.6,
    }}>
      ...
      <a href={CRISIS_HOTLINE_TEL} aria-label={`Позвонить на телефон доверия ${CRISIS_HOTLINE_DISPLAY}`} style={{
      ...
      <div style={{ fontSize: 12, color: 'var(--text-faint)' }}>
        Круглосуточно, бесплатно, анонимно. Запись сохранится как обычно —
        эта карточка ничего никуда не отправляет.
      </div>
    </div>
  );
}
