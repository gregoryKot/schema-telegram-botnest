        ...
        {steps.map((_, i) => (
          <div
            ...
            style={{
              ...
              borderRadius: 3,
              background:
                i === step ? 'var(--accent)' : 'rgba(var(--fg-rgb),0.15)',
              cursor: 'pointer',
              transition: 'all 0.2s',
            }}
          />
  ...
  return (
    <div style={{ padding: '20px 20px 40px' }}>
          ...
          <div key={n.id}>
            ...
            {showPlanCard && (
              ...
              >
                ...
                <span
                  style={{ fontSize: 16, color: color + '88', flexShrink: 0 }}
                >
                  ›
                </span>
              </div>
      ...
      >
        <div>
          <div
            style={{ fontSize: 12, color: 'var(--text-sub)', marginBottom: 4 }}
          >
            Индекс дня
          </div>
          <div
          ...
          <div style={{ fontSize: 12, color: diffColor }}>{diffText}</div>
        </div>
      ...
      {practicesCardVisible && onOpenPractices && (
        ...
        >
          ...
          <div style={{ flex: 1 }}>
            ...
            >
              {tr('Что тебе помогает?', 'Что вам помогает?')}
            </div>
            <div
              style={{ fontSize: 12, color: 'var(--text-sub)', marginTop: 2 }}
            >
              Добавь практики — будут под рукой в нужный момент
            </div>
          </div>
          <button
            onClick={(e) => {
      ...
      {activeNeed && (
        <NeedTodaySheet
          ...
          onPlanSaved={(needId) =>
            setSessionPlannedNeeds((prev) => new Set([...prev, needId]))
          }
      ...
      {activePlanNeed && (
        <PlanSheet
          ...
          onSaved={() => {
            setSessionPlannedNeeds(
              (prev) => new Set([...prev, activePlanNeed.id]),
            );
