...
const REASONS = [
  ...
  },
  {
    ...
    text: 'Этические кодексы психотерапевтических ассоциаций прямо не рекомендуют запрашивать отзывы у текущих и бывших клиентов: это защищает того, кто вам доверился.',
  },
  {
    n: '04',
