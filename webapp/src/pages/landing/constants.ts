...
export const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: 'Видеозвонок по персональной ссылке (Zoom или аналог), 50 минут. Нужны стабильный интернет, камера и микрофон. Вы находитесь там, где вам комфортно – качество работы от формата не зависит. Время выбираете прямо на сайте в блоке «Запись»; ссылка на встречу постоянная, одна на все наши сессии.',
  },
  {
