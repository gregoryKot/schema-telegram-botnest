...
export const BOUNDARIES: string[] = [
  ...
  'Зависимости (алкоголь, ПАВ) – здесь нужна профильная помощь.',
];
