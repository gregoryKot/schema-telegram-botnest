...
export const card: React.CSSProperties = {
  background: 'var(--bg-rail)', border: '1px solid var(--line)', borderRadius: 'var(--r-14)', padding: 20, marginBottom: 16,
};
export const btn: React.CSSProperties = {
  padding: '9px 16px', fontSize: 14, fontWeight: 600, fontFamily: 'inherit', cursor: 'pointer',
  background: 'var(--accent)', color: '#fff', border: 'none', borderRadius: 'var(--r-10)',
};
...
export const input: React.CSSProperties = {
  ...
  border: '1.5px solid var(--line)', borderRadius: 'var(--r-8)', color: 'var(--text)', outline: 'none', width: '100%',
};
