  ...
  },
  {
    ...
    schemas: [
      ...
      { id: 'failure',                 name: 'Неуспешность',                          emoji: '📉',
        ...
        libraryDesc: 'Убеждение в неизбежном провале в достижениях — работе, учёбе, спорте. Ощущение глупости и некомпетентности рядом с другими' },
    ],
  },
  {
    id: 'limits',
  ...
  },
  {
    ...
    schemas: [
      ...
      { id: 'unrelenting_standards',   name: 'Жёсткие стандарты / Придирчивость',        emoji: '📐',
        ...
        libraryDesc: 'Убеждение, что нужно соответствовать очень высоким требованиям — чтобы избежать критики. Цена — давление, проблемы со здоровьем и трудности в отношениях' },
      { id: 'punitiveness_self',       name: 'Пунитивность (на себя)',                   emoji: '⚔️',
        desc: 'Жёсткое наказание себя за ошибки, сложность прощать себя',
        libraryDesc: 'Убеждение, что за ошибки нужно жёстко наказывать себя. Трудность прощать себя, острая самокритика, ощущение недостойности снисхождения' },
...
export const MODE_GROUPS = [
  {
    ...
    items: [
      ...
      { id: 'abandoned_child',   name: 'Покинутый Ребёнок',  emoji: '💔', short: 'Страх, что бросят, тревога при угрозе близким отношениям' },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'invincible_oc',      name: 'Неуязвимый Гиперконтролёр',       emoji: '🛡️', short: 'Отрицает слабость — броня не снимается никогда' },
