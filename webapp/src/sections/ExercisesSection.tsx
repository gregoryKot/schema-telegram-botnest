...
const EXERCISES = [
  ...
  { id: 'letter' as ExId, num: '04', eyebrow: 'Эмоциональная работа',  title: 'Письмо уязвимому ребёнку', desc: 'Сесть рядом с собой-маленьким и сказать ему то, что он должен был услышать. От себя сегодняшнего.', time: '15–25 мин', color: 'var(--c-amber)' },
