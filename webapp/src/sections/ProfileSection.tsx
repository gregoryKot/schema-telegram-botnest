  ...
  useEffect(() => {
    ...
    Promise.all([
      ...
      Promise.all([
        ...
        .then(([sd, md, gd]) =>
          setDiaryCount(sd.length + md.length + gd.length),
        )
        .catch(() => {}),
      api
        .getYsqHistory()
        .then((h) => setYsqCount(h.length))
        .catch(() => {}),
    ...
    <div className="page-inner-wide">
      ...
      <div style={{ marginBottom: 40 }}>
        ...
        <h1 className="hub-title" style={{ marginBottom: 10 }}>
          {firstName || 'Мой'}
          <br />
          <span className="it">прогресс</span>
        </h1>
        {totalDays > 0 && (
                ...
                ? [
                    ...
                    (() => {
                      const [datePart, timePart] =
                        relation.nextSession!.includes('T')
      ...
      {showDeleteConfirm && (
        ...
        >
          ...
          >
            ...
            >
              Все данные будут удалены безвозвратно: дневники, записи, прогресс,
              настройки. Восстановить невозможно.
            </div>
