...
const buildModes = (tr: (ty: string, vy: string) => string) => [
  ...
  },
  {
    ...
    items: [
      { name: 'Карающий Критик', emoji: '😠', feel: 'стыд, «со мной что-то не так», самонаказание', desc: 'Голос, который жёстко атакует и наказывает за ошибки. Усвоенный голос значимого взрослого, который критиковал, стыдил или наказывал.' },
      ...
      { name: 'Внушающий Вину Критик', emoji: '😔', feel: 'вина, «это из-за меня», долг', desc: 'Постоянно напоминает об обязательствах перед другими, формирует чувство вины. Часто стоит за самопожертвованием и трудностью говорить «нет».' },
    ],
  },
  {
