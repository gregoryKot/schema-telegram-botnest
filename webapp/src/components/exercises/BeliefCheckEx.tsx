...
const buildSideHints = (
  ...
  3: {
    ...
    body: tr(
      'Не «всё хорошо» – это не работает. Сформулируй точнее: с оговорками, с признанием сложности, с состраданием.',
      'Не «всё хорошо» – это не работает. Сформулируйте точнее: с оговорками, с признанием сложности, с состраданием.',
    ),
    list: [
      '«иногда я ошибаюсь, и это»',
      '«часть из этого правда, и»',
      '«я устал, и это не значит»',
    ],
  },
});
