...
const NEEDS = [
  { id: 'attachment',  label: 'Привязанность',    color: 'var(--c-rose)',
    question: 'Был ли рядом взрослый, который замечал, когда было плохо, и откликался?',
  ...
  { id: 'autonomy',    label: 'Автономия',         color: 'var(--c-clay)',
    question: 'Было ли доверие – иметь своё мнение, делать выборы по возрасту, ошибаться?',
