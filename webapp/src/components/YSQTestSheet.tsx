      ...
      {phase === 'result' && scores && resultView && (() => {
        ...
        return (
          <div>
            ...
            {retakeConfirm ? (
              <div style={{ background: 'color-mix(in srgb, var(--accent-red) 8%, transparent)', borderRadius: 'var(--r-12)', padding: '14px 16px' }}>
                ...
                <div className="u-row8">
                  ...
                  <button onClick={handleRetake} style={{ flex: 1, padding: '10px', border: 'none', borderRadius: 'var(--r-10)', background: 'color-mix(in srgb, var(--accent-red) 20%, transparent)', color: 'var(--accent-red)', fontSize: 14, fontWeight: 600, cursor: 'pointer' }}>Начать заново</button>
                </div>
              </div>
            ) : (
