...
// ЛОКАЛЬНО (разошлось с мини-аппом — см. shared/src/therapy/clientSheetHelpers.ts):
// в webapp другие токены цвета и порог 5 (в мини-аппе accent-* и порог 4).
...
// ЛОКАЛЬНО: в webapp пропущено поле goals (есть в мини-аппе) — дрейф под
// продуктовое решение, не сливаю механически.
