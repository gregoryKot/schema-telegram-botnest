...
import { YESTERDAY, COLORS } from '../types';
...
export function TodayView({ needs, ratings, saved, isOffline, onChange, onSaved, onNote, onOpenPractices, onPlanCreated, plannedNeedIds, onClose: _onClose, onOpenHelp }: Props) {
