    ...
    <BottomSheet onClose={onClose}>
      <div style={{ paddingTop: 4 }}>
            ...
            return (
              <div
                ...
                style={{
                  ...
                  background: filled ? colorHex : active ? `${colorHex}55` : 'transparent',
        ...
        <div
          ...
          style={{
            background: flipped ? `${colorHex}06` : 'transparent',
            border: `1px solid ${flipped ? `${colorHex}40` : 'var(--line)'}`,
        ...
        >
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 10 }}>
            <div className="eyebrow" style={{ color: colorHex }}>
            ...
            <>
              ...
              <textarea
                ...
                style={{
                  ...
                  border: `1.5px solid ${answer.trim() ? `${colorHex}66` : 'var(--line)'}`,
