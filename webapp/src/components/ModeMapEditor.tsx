...
import {
  ...
  type Connection, type Node, type Edge, type NodeTypes, type Viewport,
} from '@xyflow/react';
...
import { ModeMapPalette, DRAG_TYPE, GROUP_TO_TYPE } from './ModeMapPalette';
...
function ModeMapCanvas({ clientId, mapId, nodes, edges, setNodes, setEdges, onNodesChange, onEdgesChange,
