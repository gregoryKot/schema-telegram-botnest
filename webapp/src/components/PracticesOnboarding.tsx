    ...
    <div style={{ position: 'fixed', inset: 0, zIndex: 250, background: 'var(--bg)', overflowY: 'auto' }}>
      <div style={{ maxWidth: 560, margin: '0 auto', padding: '48px 24px 80px' }}>
        ...
        {step === 'intro' ? (
          ...
          <div>
            {/* Progress bar */}
            <div style={{ height: 3, background: 'rgba(var(--fg-rgb),0.07)', borderRadius: 3, marginBottom: 32 }}>
              <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 14, marginBottom: 24 }}>
              ...
              <div>
                <div className="eyebrow" style={{ marginBottom: 3, color }}>
              ...
              {(CURATED[currentNeed.id] ?? []).map(text => {
                ...
                return (
                  ...
                  >
                    ...
                    <span style={{ fontSize: 14, color: on ? 'var(--text)' : 'rgba(var(--fg-rgb),0.7)', lineHeight: 1.4 }}>{text}</span>
                  </div>
                );
              })}
            </div>
            ...
            <div style={{ display: 'flex', gap: 10 }}>
              ...
              <button
                ...
                style={{
                  ...
                  color: (selected.size > 0 || input.trim()) ? '#fff' : 'rgba(var(--fg-rgb),0.3)',
