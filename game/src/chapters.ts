...
// Урок главы: «залипни» здесь — ловушка. Телефон выключается ударом,
...
const chapter3: ChapterConfig = {
  ...
  triggers: [
    ...
    { x: 2600, critic: true },                      // тень догоняет ДО финального подхода: у двери она только шепчет, урона нет
  ],
