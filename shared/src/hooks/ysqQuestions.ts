...
export const QUESTIONS: string[] = [
  ...
  'В трудные минуты я обычно остаюсь наедине со своими переживаниями.',
  ...
  'Я держусь на расстоянии — нет уверенности, что человек останется рядом.',
  ...
  'Если люди разглядят меня по-настоящему, кто-нибудь непременно обратит это мне во вред.',
  ...
  'Мне кажется, что я в чём-то принципиально отличаюсь от остальных.',
  'Мне сложно ощутить принадлежность хоть к какой-то группе или компании.',
  'В любом коллективе я скорее чувствую себя не на своём месте.',
  'Мне кажется, что по-настоящему меня понимают немногие.',
  'Среди людей меня часто не отпускает ощущение чужести.',
  ...
  'Мне сложно поверить, что меня можно любить без прикрас.',
  ...
  'Мне не хватает уверенности, что я справлюсь с повседневными задачами в одиночку.',
  'Кажется, другие способны позаботиться обо мне лучше, чем я о себе.',
  'Браться за незнакомое дело без чьей-то поддержки мне тяжело.',
  'Часто кажется: за что ни возьмусь — толком ничего не выйдет.',
  ...
  'Мне привычно уступать другим право решать за меня.',
  'За меня так часто выбирали, что я уже почти не понимаю, чего хочу.',
  ...
  'Сколько бы ни было дел, для чужих нужд время находится всегда.',
  'Обычно именно я выслушиваю чужие беды.',
  'Мне говорят, что я слишком многим жертвую ради других.',
  'Сколько ни делаю для людей, внутри остаётся чувство, что этого мало.',
  'Мысль, что я могу потерять контроль над собой, меня пугает.',
  'Я побаиваюсь, что в сильном гневе могу кому-то навредить.',
  ...
  'Чувствую, что обязательно нужно довести до конца всё, за что берусь.',
  ...
  'Я постоянно тянусь к максимальной продуктивности и результативности.',
  ...
  'Мне свойственно действовать импульсивно и потом об этом жалеть.',
  ...
  'Если не справляюсь — значит, полагается понести последствия без исключений.',
  'Причина промаха для меня не так важна: промах есть — отвечай.',
  'В глубине души порой чувствую, что заслуживаю наказания.',
