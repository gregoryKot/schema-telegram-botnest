...
// Жил в schema-miniapp/src/utils/breathing.ts, пока практики были только в
// мини-аппе; переехал в shared при переносе «Здесь и сейчас» на сайт
// (правило №3: один источник вместо копии на каждой площадке).
