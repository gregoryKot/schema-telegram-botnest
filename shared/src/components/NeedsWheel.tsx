// Колесо потребностей (история дня): лепестки-оценки, контур «колеса
// детства», индекс в центре. Единственная копия (правило №3) — версии
// фронтов были семантически идентичны и разошлись только форматом.
