// Общие константы настроек уведомлений (таймзоны, часы, частота, тихие часы)
// — единый источник для webapp и miniapp (правило №3/№11). Раньше дублировались
// инлайном в обоих SettingsSheet.
