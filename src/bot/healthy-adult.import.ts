...
/**
 * Сколько первых слов считаем «стартовой конструкцией». Два, а не три:
 * бриф называет конструкциями именно двусловные зачины — «Ты сегодня…»,
 * «Если ты…», «Тебе можно…». При трёх словах «Ты сегодня сделал» и
 * «Ты сегодня ничего» считались бы разными, хотя это один и тот же приём.
 */
